Набор плагинов для ваультов Обсидиана

| Название плагина              | Автор            |
| ----------------------------- | ---------------- |
| Templater                     | SilentVoid       |
| Front Matter Title            | Snezhig          |
...
| Another Sticky Headings       | zhouhua          |
| Sticky Notes                  | abdo-reda        |
| Better Word Count             | Luke Leppan      |
| Calendar                      | Liam Cain        |
| Cards View                    | Maud Royer       |
| Chem                          | Acylation        |
| Color Palette                 | ALegendsTale     |
| Colored Tags                  | Pavel Frankov    |
| Continuous Mode               | Michael Brenan   |
| Daily Stats                   | Dhruvik Parikh   |
| Dictionary                    | phibr0           |
| Editing Toolbar               | Cuman            |
| File Color                    | ecusitc          |
| File Explorer++               | kelszo           |
| File Info Panel               | T. L. Ford       |
| File Preview                  | Huajin           |
| Folders to Graph              | ratibus11        |
| Highlightr                    | chetachi         |
| Iconic                        | Holo             |
...
| TagFolder                     | vrtmrz           |
| Tag Wrangler                  | PJ Eby           |
| Trash Explorer                | Per Mortnensen   |
| Unicode Search                | BambusControl    |
| Vault Explorer                | DecafDev         |
| Vault Name                    | @gampiss         |
|                               |                  |
| Wakatime                      |                  |
